 ...
 *
 * PongEffect_mexutil.h
 *
 * Code generation for function 'PongEffect_mexutil'
 *
 */

#ifndef PONGEFFECT_MEXUTIL_H
#define PONGEFFECT_MEXUTIL_H
...
/* End of code generation (PongEffect_mexutil.h) */
