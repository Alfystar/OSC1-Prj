 ...
 *
 * PongEffectRLSpeed_emxutil.h
 *
 * Code generation for function 'PongEffectRLSpeed_emxutil'
 *
 */

#ifndef PONGEFFECTRLSPEED_EMXUTIL_H
#define PONGEFFECTRLSPEED_EMXUTIL_H
...
/* End of code generation (PongEffectRLSpeed_emxutil.h) */
