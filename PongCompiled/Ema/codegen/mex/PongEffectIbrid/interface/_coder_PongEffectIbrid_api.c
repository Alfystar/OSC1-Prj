 ...
 *
 * _coder_PongEffectIbrid_api.c
 *
 * Code generation for function '_coder_PongEffectIbrid_api'
 *
 */
...
static emlrtRTEInfo n_emlrtRTEI = { 1, /* lineNo */
  1,                                   /* colNo */
  "_coder_PongEffectIbrid_api",        /* fName */
  ""                                   /* pName */
};
  ...
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  ...
  ret->size[0] = iv13[0];
  ret->size[1] = iv13[1];
  emxEnsureCapacity_real_T(sp, ret, i16, (emlrtRTEInfo *)NULL);
  ret->data = (real_T *)emlrtMxGetData(src);
  ret->canFreeData = false;
  emlrtDestroyArray(&src);
}

void PongEffectIbrid_api(const mxArray *prhs[10], int32_T nlhs, const mxArray
  *plhs[7])
{
  emxArray_real_T *G;
  ...
  emxInit_real_T(&st, &G, 2, &n_emlrtRTEI, true);
  ...
  unusedU0 = emlrt_marshallIn(&st, emlrtAliasP(prhs[6]), "unusedU0");
  G->canFreeData = false;
  i_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_7), "G", G);
  SBROnOff = emlrt_marshallIn(&st, emlrtAliasP(prhs[8]), "SBROnOff");
  unusedU1 = emlrt_marshallIn(&st, emlrtAliasP(prhs[9]), "unusedU1");

  /* Marshall in global variables */
  MEXGlobalSyncInFunction(&st);

  /* Invoke the target function */
  PongEffectIbrid(&st, xb0, yb0, ys0, *Qup, *Qdown, *Qstill, unusedU0, G,
                  SBROnOff, unusedU1, &chk, &score, &rimbalzi);
...
/* End of code generation (_coder_PongEffectIbrid_api.c) */
