...
while(i <= 10^6)
    ...
    for j=1:ite
        ...
        yp0 = (H-1)*bRnd+1;
        if(plays<=5)
            [~,Qup,Qdown,Qstill,score,rimbalzi, G] = PongEffectIbrid(xb0,yb0,yp0,Qup,Qdown,Qstill,0,G,1,0);
        else
            [~,Qup,Qdown,Qstill,score,rimbalzi, G] = PongEffectIbrid(xb0,yb0,yp0,Qup,Qdown,Qstill,0,G,0,0);
        end
