...
static emlrtRTEInfo emlrtRTEI = { 385, /* lineNo */
  5,                                   /* colNo */
  "id2Coord",                          /* fName */
  "C:\\Users\\Filippo Badalamenti\\Desktop\\Uni\\OSC\\OSC 1\\osc1-2\\1_OSC1\\PongAI\\PongEffect.m"/* pName */
};
...
void PongEffect(const emlrtStack *sp, real_T xb0, real_T yb0, real_T ys0, real_T
                Qup[504], real_T Qdown[504], real_T Qstill[504], real_T figOnOff,
                emxArray_real_T *G, real_T SBROnOff, real_T SBRspeedOnOff,
                real_T *chk, real_T *score, real_T *rimbalzi)
{
    ...
    if (lambda > eps) {
      ...
      if (lambda < eps) {
        ...
        if ((lambda < 0.33) && (ys + 1.0 <= H - 0.2)) {
          ...
          if ((lambda >= 0.33) && (lambda < 0.66) && (ys - 1.0 >= 0.2)) {
            ys -= 0.2;
            ctr = -1.0;
          }
        }
...
/* End of code generation (PongEffect.c) */
