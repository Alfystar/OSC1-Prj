 ...
 *
 * PongEffect_emxutil.h
 *
 * Code generation for function 'PongEffect_emxutil'
 *
 */

#ifndef PONGEFFECT_EMXUTIL_H
#define PONGEFFECT_EMXUTIL_H
...
/* End of code generation (PongEffect_emxutil.h) */
