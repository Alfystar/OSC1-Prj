 ...
 *
 * _coder_PongEffectTrunc_api.c
 *
 * Code generation for function '_coder_PongEffectTrunc_api'
 *
 */
  ...
  mxArray *plhs[7])
{
  ...
  PongEffectTrunc(&st, xb0, yb0, ys0, *Qup, *Qdown, *Qstill, unusedU0, G,
...
/* End of code generation (_coder_PongEffectTrunc_api.c) */
