 ...
 *
 * PongEffectIbrid_data.h
 *
 * Code generation for function 'PongEffectIbrid_data'
 *
 */

#ifndef PONGEFFECTIBRID_DATA_H
#define PONGEFFECTIBRID_DATA_H
...
extern real_T eps;
extern real_T alpha;
extern real_T b_gamma;
extern real_T Ln;
extern real_T Hn;
extern real_T V[7];
extern real_T velSig;
extern uint32_T beta_dirty;
extern uint32_T L_dirty;
extern uint32_T H_dirty;
extern uint32_T eps_dirty;
extern uint32_T alpha_dirty;
extern uint32_T gamma_dirty;
extern uint32_T Ln_dirty;
extern uint32_T Hn_dirty;
extern uint32_T V_dirty;
extern uint32_T velSig_dirty;
...
/* End of code generation (PongEffectIbrid_data.h) */
