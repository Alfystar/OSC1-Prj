 ...
 *
 * _coder_PongEffect_api.c
 *
 * Code generation for function '_coder_PongEffect_api'
 *
 */
...
void PongEffect_api(const mxArray *prhs[10], int32_T nlhs, const mxArray *plhs[7])
{
  emxArray_real_T *G;
  ...
  PongEffect(&st, xb0, yb0, ys0, *Qup, *Qdown, *Qstill, figOnOff, G, SBROnOff,
             SBRspeedOnOff, &chk, &score, &rimbalzi);
...
/* End of code generation (_coder_PongEffect_api.c) */
